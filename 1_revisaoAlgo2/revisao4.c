/*
Fazer um sistema modularizado que cadastre alunos com matr�cula
e nome.
Entretanto, o m�dulo respons�vel pelo cadastro n�o pode permitir
duas matr�culas iguais no vetor.
O tamanho do vetor deve ser definido pelo usu�rio.
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
